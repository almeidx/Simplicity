...
class GuildParameter extends Parameter {
  ...
  static search (query, { client, guild }, options) {
    ...
    if (typeof query !== 'string')
      throw new Error(`The search input can't be type '${typeof query}'`)
    ...
    if (!options.canBeUnavailable && !guild.available)
      throw new CommandError(options.errors.canBeUnavailable)
