  ...
  if (chan) {
    if (oldMessage.content !== newMessage.content) { // Message Edits
      let embed = new MessageEmbed()
        ...
        .addField('Before', oldMessage.content.slice(0, 1020) + oldMessage.content.length >= 1024 ? '...' : '', true)
        .addField('After', newMessage.content.slice(0, 1020) + newMessage.content.length >= 1024 ? '...' : '', true)
